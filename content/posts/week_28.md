...
to [Fagagna](https://www.turismofvg.it/locality/fagagna) with my partner
and my dogs in a couple of weeks. Nice places, nice food, and nice
company: I can't ask for more.

## JavaScript and Vue.js

I have to use [Vue.js](https://vuejs.org/) on one of my client's
...
I recently watched and enjoyed David Nolen's talk [ClojureScript from
First Principles](https://www.youtube.com/watch?v=An-ImWVppNQ), and he
makes a lot of good points about the current state of JS. It was
interesting to learn why ClojureScript was based on the [Google Closure
Compiler](https://developers.google.com/closure/compiler) and how
powerful it is out of the box (no shadow-cljs needed).

Some food for thought:

- Even if there are better JS tools nowadays, web pages aren't faster or
  lighter.
- If the modern JS story is so great, why is there an overall sense of
...
In my spare time, I'm working on a small project to see if it's possible
to train a neural network to return the spectrophotometric curve, given
its [L**a\*b**](https://en.wikipedia.org/wiki/CIELAB_color_space)
values. I have a moderately sized dataset (300k+) to refine to make it
truly useful. I'm using [TensorFlow](https://www.tensorflow.org/),
[pandas](https://pandas.pydata.org/),
[scikit-learn](https://scikit-learn.org/), and the
[Colour](https://www.colour-science.org/) library. As soon as I get good
results, I'll probably write an post.

## Moving from GitHub

I'm cleaning up and moving my private repositories from GitHub to a
self-hosted instance of Gitea. It's probably a bit too late to escape
Copilot, but it's never too late to keep AI away from my personal code.

## Desktop environment

In the last few months, I moved from Gnome to KDE, and back to Gnome.

KDE was one of my first desktop environments (TBH, [Window
Maker](https://www.windowmaker.org/) was my first, on Debian Potato),
but it's not that stable on Wayland. (Sorry, guys, I think X11 is
dying.) Gnome is the least worst alternative I could find.

Earlier this year, I tried different window managers:
[sway](https://swaywm.org/),
[river](https://isaacfreund.com/software/river/), and
[niri](https://github.com/YaLTeR/niri). I think niri is the way to go
...
Niri really nails down this way of working. The only thing that keeps me
...
manager… It's too much for me to handle.
