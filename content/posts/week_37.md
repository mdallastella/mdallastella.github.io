...
resonate with [Jiddu
Krishnamurti](https://en.wikipedia.org/wiki/Jiddu_Krishnamurti) when he
said:
...
> follow someone you cease to follow Truth.

Truth is a process, not a goal.

## Code

Clojure still amazes me, even after more than ten years: the community
continues to produce wonderful stuff… It's inspirational.

I gave up on Rust; I have no use at the moment for low-level code. And
even if I need some, I think I'll take a look at
[Zig](https://ziglang.org/).

I'd like to try again with music frameworks like
[TidalCycle](https://tidalcycles.org/) or
[Overtone](https://overtone.github.io/).

I've been following the [Helix editor](https://helix-editor.com/) for a
while now; I like the [Kakoune](https://kakoune.org/) modal editing
philosophy, and I'm really excited by Helix plugin system based on
[Steel](https://github.com/mattwparas/steel) (a Scheme interpreter
written in Rust). There are some people against this decision, and I
expressed myself in the discussion on Github:

- [Using Lisp dialect as a language of choice for plugin system is a bad
  decisio…](https://github.com/helix-editor/helix/discussions/13464)

## Notable links of the week

- [Open source means surrendering your monopoly over commercial
  exploitation](https://drewdevault.com/2021/01/20/FOSS-is-to-surrender-your-monopoly.html)
- [GitHub - edent/SuperTinyIcons: Under 1KB each! Super Tiny Icons are
  miniscule…](https://github.com/edent/SuperTinyIcons)
- [Seedship](https://philome.la/johnayliff/seedship/play/index.html)
  (Game)
- [Clojure's Solutions to the Expression Problem -
  InfoQ](https://www.infoq.com/presentations/Clojure-Expression-Problem/)
