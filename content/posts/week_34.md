...
on this earth that I'll ever live.

Time is relative for sure. If you have a PhD in physics, sorry for the
joke.

The "Gone" book I'm reading is not that bad, but it's reeealllyy
...
alongside the reader like Harry Potter books.

I bought myself a pair of [Moondrop Space Travel
2](https://moondroplab.com/en/products/space-travel-2): they sound
really good for their low price.

## Code

It was a quiet week, a lot of people were still on holiday leaves. Still
...
[computed](https://vuejs.org/guide/essentials/computed.html) hides its
reactive dependencies, errors in the browser console are hard to
understand. I don't like it at all.

I keep going on with my Rust studies, even if I find quite hard to
...
struggle against the language?

I also worked a bit on another Babashka script for
[waybar](https://github.com/Alexays/Waybar) widgets, a tailscale simple
...
- [Why LLM predictions are dangerous for Finance? - DEV Community](https://dev.to/pvgomes/why-llm-predictions-are-dangerous-for-finance-j2i)
